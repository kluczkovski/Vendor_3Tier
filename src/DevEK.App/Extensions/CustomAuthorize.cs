...
namespace DevEK.App.Extensions
{
    ...
    {
        public static bool CheckClaimsUser(HttpContext context, string claimName, string claimValue)
        {
    ...
    public class RequirementClaimFilter : IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            if (!CustomAuthorization.CheckClaimsUser(context.HttpContext, _claim.Type, _claim.Value))
            {
